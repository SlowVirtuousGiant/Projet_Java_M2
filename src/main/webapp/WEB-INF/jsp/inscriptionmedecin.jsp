...
<section>
    <div class="container px-4 py-5 mx-auto">
            <div class="d-flex flex-lg-row flex-column-reverse">
                <form method="post" action=inscriptionmedecinprocess>
                <div class="card card1">
                    <div class="col-md-8 col-10 my-5">
                        <h2 class="mb-5 text-center heading">Ajouter un medecin<br></h2>
                        <h6 class="msg-info">Nouveau medecin</h6>
                ...
                <div class="card card1">
                    <div class="row justify-content-center my-auto">
                        ...
                        <div class="row justify-content-center my-3 px-3"> <button
                                ...
                                class="w-100 btn btn-lg btn-outline-success">Ajouter</button>
                        </div>
